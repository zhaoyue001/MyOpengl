...
int main()
{
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        glBindVertexArray(prog.getVAO()); // seeing as we only have a single VAO there's no need to bind it every time, but we'll do so to keep things a bit more organized
